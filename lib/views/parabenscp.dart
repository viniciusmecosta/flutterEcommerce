...
class ParabensCp extends StatefulWidget {
  const ParabensCp({super.key});

  @override
  State<ParabensCp> createState() => _ParabensCpState();
}

class _ParabensCpState extends State<ParabensCp> {
  @override
      ...
      child: Stack(
        children: [
          ...
          Container(
            ...
            width: comprimento * 0.7,
            child: Center(
              child: Text("Pagamento concluído com sucesso!!",
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey,
                    fontWeight: FontWeight.w400,
